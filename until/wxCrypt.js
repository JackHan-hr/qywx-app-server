 ...
 * @param {String} id             CorpId或者AppId
 */
var WxCrypt = function (token, encodingAESKey, id) {
 ...
 */
WxCrypt.prototype.decrypt = function(text) {
 ...
 */
WxCrypt.prototype.encrypt = function (text) {
  // 算法：AES_Encrypt[random(16B) + msg_len(4B) + msg + $CorpID]
  // 获取16B的随机字符串
